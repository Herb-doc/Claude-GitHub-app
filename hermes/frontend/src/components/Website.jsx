    ...
    try {
      ...
      const response = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({
          ...
          max_tokens: 4096,
          system: `You are HERMES, drafting public-facing website and practice content for Daniel M. Phend, ND, MH — a Naturopathic Doctor and Master Herbalist with 40+ years of clinical experience, specializing in immune and autoimmune disorders. His practice is About Your Body LLC in La Porte, Indiana, online at aboutyourbody.net.
